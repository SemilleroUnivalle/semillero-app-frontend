...
import PreguntaCard, {
  Pregunta,
} from "../../../../../components/pruebas/PreguntaCard";
    ...
    <Box className="inputs-textfield mx-auto flex w-11/12 flex-col rounded-2xl bg-white p-4">
      ...
      <Box className="mt-4">
        <Typography variant="body1" className="mb-4 text-secondary">
          Agrega preguntas independientes al banco de preguntas. Puedes
          asociarlas a un módulo opcionalmente.
        </Typography>

        <FormControl fullWidth>
          <InputLabel id="modulo_label">Módulo (Opcional)</InputLabel>
          <Select
            labelId="modulo_label"
          ...
          >
            ...
            {modulos.map((mod) => (
              <MenuItem key={mod.id_modulo} value={mod.id_modulo}>
                {mod.nombre_modulo}
              </MenuItem>
            ))}
          </Select>
