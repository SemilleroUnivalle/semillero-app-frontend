...
const mockDatosPorPrueba: {
    ...
    prueba_1: {
        estudiantes: [
            { id: 1, nombre: "Ana García", puntaje: 95, clasificacion: "Apto-Avanzado", presentada: true },
            { id: 2, nombre: "Carlos López", puntaje: 82, clasificacion: "Apto-Curso Base", presentada: true },
            { id: 3, nombre: "María Rodríguez", puntaje: 45, clasificacion: "No Apto", presentada: true },
            { id: 4, nombre: "Juan Pérez", puntaje: 74, clasificacion: "Apto-Curso Base", presentada: true },
            { id: 5, nombre: "Laura Martínez", puntaje: 88, clasificacion: "Apto-Avanzado", presentada: true },
            { id: 6, nombre: "Pedro Sánchez", puntaje: 35, clasificacion: "No Apto", presentada: true },
            { id: 7, nombre: "Sofía Torres", puntaje: 92, clasificacion: "Apto-Avanzado", presentada: true },
            { id: 8, nombre: "Diego Ruiz", puntaje: 65, clasificacion: "Apto-Curso Base", presentada: true },
            { id: 9, nombre: "Emma Vargas", puntaje: 0, clasificacion: "Sin presentar", presentada: false },
            { id: 10, nombre: "Felipe Mora", puntaje: 0, clasificacion: "Sin presentar", presentada: false },
        ],
        preguntasAciertos: [
    ...
    prueba_2: {
        estudiantes: [
            { id: 1, nombre: "Ana García", puntaje: 88, clasificacion: "Apto-Avanzado", presentada: true },
            { id: 2, nombre: "Carlos López", puntaje: 72, clasificacion: "Apto-Curso Base", presentada: true },
            { id: 3, nombre: "María Rodríguez", puntaje: 52, clasificacion: "No Apto", presentada: true },
            { id: 4, nombre: "Juan Pérez", puntaje: 68, clasificacion: "Apto-Curso Base", presentada: true },
            { id: 5, nombre: "Laura Martínez", puntaje: 91, clasificacion: "Apto-Avanzado", presentada: true },
            { id: 6, nombre: "Pedro Sánchez", puntaje: 0, clasificacion: "Sin presentar", presentada: false },
            { id: 7, nombre: "Sofía Torres", puntaje: 85, clasificacion: "Apto-Avanzado", presentada: true },
            { id: 8, nombre: "Diego Ruiz", puntaje: 0, clasificacion: "Sin presentar", presentada: false },
            { id: 9, nombre: "Emma Vargas", puntaje: 75, clasificacion: "Apto-Curso Base", presentada: true },
            { id: 10, nombre: "Felipe Mora", puntaje: 58, clasificacion: "No Apto", presentada: true },
        ],
        preguntasAciertos: [
    ...
    prueba_3: {
        estudiantes: [
            { id: 1, nombre: "Ana García", puntaje: 98, clasificacion: "Apto-Avanzado", presentada: true },
            { id: 2, nombre: "Carlos López", puntaje: 76, clasificacion: "Apto-Curso Base", presentada: true },
            { id: 3, nombre: "María Rodríguez", puntaje: 48, clasificacion: "No Apto", presentada: true },
            { id: 4, nombre: "Juan Pérez", puntaje: 70, clasificacion: "Apto-Curso Base", presentada: true },
            { id: 5, nombre: "Laura Martínez", puntaje: 0, clasificacion: "Sin presentar", presentada: false },
            { id: 6, nombre: "Pedro Sánchez", puntaje: 42, clasificacion: "No Apto", presentada: true },
            { id: 7, nombre: "Sofía Torres", puntaje: 89, clasificacion: "Apto-Avanzado", presentada: true },
            { id: 8, nombre: "Diego Ruiz", puntaje: 77, clasificacion: "Apto-Curso Base", presentada: true },
            { id: 9, nombre: "Emma Vargas", puntaje: 0, clasificacion: "Sin presentar", presentada: false },
            { id: 10, nombre: "Felipe Mora", puntaje: 94, clasificacion: "Apto-Avanzado", presentada: true },
        ],
        preguntasAciertos: [
...
export default function EstadisticasPruebasDiagnosticas() {
    ...
    const clasificacionDistribucion = [
        { 
            name: "Apto-Avanzado", 
            value: mockEstudiantes.filter(e => e.clasificacion === "Apto-Avanzado").length,
            color: "#22c55e"
        },
        { 
            name: "Apto-Curso Base", 
            value: mockEstudiantes.filter(e => e.clasificacion === "Apto-Curso Base").length,
            color: "#3b82f6"
        },
        { 
            name: "No Apto", 
            value: mockEstudiantes.filter(e => e.clasificacion === "No Apto").length,
            color: "#ef4444"
        },
        { 
            name: "Sin presentar", 
            value: mockEstudiantes.filter(e => e.clasificacion === "Sin presentar").length,
            color: "#94a3b8"
        },
    ].filter(d => d.value > 0);
    ...
    return (
        <Box className="mx-auto w-11/12 pb-8">
            ...
            <div className="mb-6 grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 w-full">
                ...
                <Card className="h-full rounded-xl shadow-sm transition-transform hover:scale-105">
                    <CardContent className="flex flex-col items-center justify-center p-6">
                        ...
                        <Typography variant="h4" className="font-bold text-gray-800">
                            {pruebaspresentadas > 0 ? ((pruebaspresentadas / mockEstudiantes.length) * 100).toFixed(0) : 0}%
                        </Typography>
                        <Typography variant="body2" color="text.secondary">
                            ...
                            <Table size="small">
                                <TableHead>
                                    <TableRow sx={{ backgroundColor: "#f5f5f5" }}>
                                        ...
                                        <TableCell className="font-bold" align="center">Clasificación</TableCell>
                            ...
                            {clasificacionDistribucion.map((item) => (
                                <Box key={item.name} className="flex items-center justify-between">
                                    ...
                                    <Typography variant="body2" className="font-bold">
                                        {item.value} ({((item.value / mockEstudiantes.length) * 100).toFixed(0)}%)
                                    </Typography>
                                </Box>
                            ))}
                        </Box>
