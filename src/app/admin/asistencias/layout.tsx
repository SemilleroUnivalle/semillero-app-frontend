...
export default function LayoutAsistencias({
  children,
}: {
  ...
  const basePath = "/admin/asistencias";
  ...
  const breadcrumbLinks = [
    { href: basePath, label: "Asistencias" },
    ...
    <StyledEngineProvider injectFirst>
      <div className="flex flex-col">
        ...
        <div className="mx-auto my-4 flex w-11/12 flex-wrap justify-around gap-2">
          <Link href="/admin/asistencias/ver-asistencias/" className="w-full sm:w-1/4">
            <Button
          ...
          <Link href="/admin/asistencias/crear-asistencias/" className="w-full sm:w-1/4">
            <Button
              className="w-full rounded-2xl bg-white p-4 capitalize text-secondary hover:bg-primary hover:text-white"
              variant="contained"
            >
