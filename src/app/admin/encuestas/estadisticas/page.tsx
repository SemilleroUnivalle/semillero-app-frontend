...
const AREAS_DATA = [
  ...
  { area: "Química", modulo: 4.2, docente: 4.5, monitor: 4.4, estudiante: 4.2 },
  { area: "Artes", modulo: 4.5, docente: 4.72, monitor: 4.6, estudiante: 4.4 },
  {
    area: "Lenguaje",
    modulo: 4.7,
    docente: 4.9,
...
const DETALLE_MODULOS = [
  ...
  {
    id: 3,
    modulo: "Química Orgánica Básica",
    area: "Química",
    docente: "Laura Méndez",
    docenteScore: 4.5,
    monitorName: "Valeria Rios",
    monitor: 4.4,
    modulo_score: 4.2,
    estudiante: 4.2,
    respuestas: 120,
  ...
  {
    id: 4,
    modulo: "Laboratorio de Reacciones",
    area: "Química",
    docente: "Laura Méndez",
    docenteScore: 4.3,
    monitorName: "Valeria Rios",
  ...
  {
    id: 5,
    modulo: "Pintura y Expresión Visual",
    area: "Artes",
    docente: "Sandra Gómez",
    docenteScore: 4.7,
    monitorName: "Daniela Cruz",
    monitor: 4.6,
    modulo_score: 4.5,
    estudiante: 4.4,
    respuestas: 150,
...
export default function EstadisticasEncuestasPage() {
  ...
  const evolutionChart = useMemo<{
    ...
    return {
      options: {
        ...
        tooltip: {
          y: {
            formatter: (v: number) => `${v.toFixed(2)} / 5.0`,
          },
        },
        legend: {
          position: "top",
      ...
      series: [
        ...
        {
          name: "Autoevaluación",
          data: SEMESTRES_DATA.map((d) => d.estudiante),
        },
      ],
    };
  }, []);
  ...
  const filteredList = useMemo(() => {
    return DETALLE_MODULOS.filter((item) => {
      ...
      const matchesArea =
        selectedArea === "Todos" || item.area === selectedArea;
      const matchesDocente =
        selectedDocente === "Todos" || item.docente === selectedDocente;
      const matchesMonitor =
        selectedMonitor === "Todos" || item.monitorName === selectedMonitor;
      const matchesAreaGlobal =
        selectedAreaGlobal === "Todos" || item.area === selectedAreaGlobal;
      return (
        matchesSearch &&
        matchesArea &&
        matchesDocente &&
      ...
      >
        ...
        >
          <FormControl size="small" sx={{ width: 170 }}>
            <InputLabel id="select-semestre-label">
              Periodo Semestral
            </InputLabel>
            <Select
          ...
          <FormControl size="small" sx={{ width: 160 }}>
            <InputLabel id="select-area-global-label">
              Área Acad\u00e9mica
            </InputLabel>
            <Select
          ...
          <FormControl size="small" sx={{ width: 180 }}>
            <InputLabel id="select-monitor-label">
              Monitor Acad\u00e9mico
            </InputLabel>
            <Select
          ...
          >
            <Table sx={{ minWidth: 700 }}>
              <TableHead sx={{ backgroundColor: "#e8e8e8" }}>
                <TableRow>
                  <TableCell sx={{ fontWeight: 750, color: "#575757" }}>
                    Módulo
                  </TableCell>
                  <TableCell sx={{ fontWeight: 750, color: "#575757" }}>
                    Área
                  ...
                  <TableCell
                    align="center"
                    sx={{ fontWeight: 750, color: "#575757" }}
                  >
                    Monitor
                  </TableCell>
                  <TableCell
