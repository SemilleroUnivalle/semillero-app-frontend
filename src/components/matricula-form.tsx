      ...
      return {
        validate: () => {
          ...
          if (reciboServicio && reciboServicio.size > 2 * 1024 * 1024) {
            alert(
              "El recibo de servicios excede el tamaño máximo permitido (2 MB)",
            );
            return false;
          }
        ...
        getFormData: () => {
          const ofertaSeleccionada = formData.oferta
          ...
          return {
            ...
            id_oferta_categoria: ofertaSeleccionada?.id_oferta_categoria
              ? String(ofertaSeleccionada.id_oferta_categoria)
              : "",
          };
        },
      };
